...
awslocal sns publish --endpoint-url=http://localhost:4566 --topic-arn=arn:aws:sns:us-east-1:000000000000:notification_events --message="Hello World" --region=us-east-1 --output=json | cat
...
awslocal sqs delete-message --endpoint-url=http://localhost:4566 --queue-url=http://localhost:4566/000000000000/test_queue --region=us-east-1  --receipt-handle=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

# delete SNS topic
awslocal sns delete-topic --topic-arn=arn:aws:sns:us-east-1:000000000000:notification_events
